...
% model1 = changeRxnBounds(model1, 'EX_CS_OH',0.000783292, 'l');
% model1 = changeRxnBounds(model1, 'EX_CS_OH',0.000783292, 'u');

% model1 = changeObjective(model1,'BIOMASS_Ec_iJO1366_WT_53p95M', 1);
% FBA = optimizeCbModel(model1,'max');
% FBA.f;
