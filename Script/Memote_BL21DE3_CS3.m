...
outmodel = writeCbModel(model, 'format','mat', 'fileName', 'NewBL21DE3_CS3.mat');
 %% Optional : get memote report
% sbmlModel = writeSBML(model, 'NewBL21DE3_CS3');
% command = 'memote report snapshot --filename "Memote_BL21DE3_CS3.html" NewBL21DE3_CS3.xml'; % 
